...
import 'package:flutter_netease_music_api/src/api/bean.dart';
import 'package:flutter_netease_music_api/src/api/dj/api.dart';
import 'package:flutter_netease_music_api/src/api/event/api.dart';
import 'package:flutter_netease_music_api/src/api/login/bean.dart';
import 'package:flutter_netease_music_api/src/api/search/api.dart';
import 'package:flutter_netease_music_api/src/api/uncategorized/api.dart';
import 'package:flutter_netease_music_api/src/api/user/api.dart';
import 'package:flutter_netease_music_api/src/dio_ext.dart';
...
class NeteaseMusicApi
  ...
  static Future<bool> init({PathProvider? provider, bool debug = false}) async {
    print("initinitinitinitinitinitinitinitinitinitinit");
